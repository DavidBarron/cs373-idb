...
class APItests3(unittest.TestCase):
    ...
    def test_player_api4(self):
        ...
        self.assertEqual(response.getcode(), 200)
        response_data = loads(response_body)        
        self.assertEqual(response_data["name"], "Senquez Golson")
        self.assertEqual(response_data["team"], "http://yetanotherfootballdb.me/api/teams/21/")
        self.assertEqual(response_data["number"], "21")
        self.assertEqual(response_data["position"], "CB")
        self.assertEqual(response_data["height"], "5-9")
        self.assertEqual(response_data["weight"], "176")
        self.assertEqual(response_data["age"], "22")
        self.assertEqual(response_data["experience"], "R")
        self.assertEqual(response_data["college"], "Ole Miss")
       	self.assertEqual(response_data["pimage"], "http://capstone.cryotek.org/img/team/empty-compressed.png")
